...
byte VUDown(int StartPos, int EndPos, byte Freq, byte MaxFreq, byte ColourSelector)
{
  ...
  //peak tracker
  strip.setPixelColor(EndPos - map(MaxFreq, 0, 255, 0, totalLength), Wheel(peakColour));
...
byte VUUp(int StartPos, int EndPos, byte Freq, byte MaxFreq, byte ColourSelector)
{
  ...
  //peak tracker
  strip.setPixelColor(StartPos + map(MaxFreq, 0, 255, 0, totalLength), Wheel(peakColour));
